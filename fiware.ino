...
const char* ssid = “MOVISTAR_0D30";

const char* password =”onFMffkgHNYm33Ng7hf7";

const char* servidor2=»http://192.168.1.41:1026/v2/entities/attributs»;

const char* servidor=»http://192.168.1.41:1026/v2/entities/»;
